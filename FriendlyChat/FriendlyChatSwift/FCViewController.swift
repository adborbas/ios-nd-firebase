...
class FCViewController: UIViewController, UINavigationControllerDelegate {
    ...
    private var service: FirendlyChatService!
    ...
    func configureDatabase() {
        self.service = FireBaseFirendlyChat()
    ...
    @IBAction func didSendMessage(_ sender: UIButton) {
        let _ = self.textFieldShouldReturn(messageTextField)
...
extension FCViewController: UITextFieldDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        if !textField.text!.isEmpty {
            let message = Message(user: self.user!.displayName!, text: textField.text!)
...
extension FCViewController: FirendlyChatServiceDelegate {
